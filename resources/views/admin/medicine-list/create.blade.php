{{-- File: resources/views/dashboard/admin/create-medicine.blade.php --}}
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('medicine.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_obat" id="nama_obat" class="w-full px-4 py-2 border rounded-lg" value="{{ old('nama_obat') }}" required>
                            @error('nama_obat')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" id="deskripsi" class="w-full px-4 py-2 border rounded-lg" required>{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <span class="text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="stok" id="stok" class="w-full px-4 py-2 border rounded-lg" value="{{ old('stok') }}" min="0" required>
                            @error('stok')
                                <span class="text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="kedaluwarsa" id="kedaluwarsa" class="w-full px-4 py-2 border rounded-lg" value="{{ old('kedaluwarsa') }}" required>
                            @error('kedaluwarsa')
                                <span class="text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg">Tambah</button>
